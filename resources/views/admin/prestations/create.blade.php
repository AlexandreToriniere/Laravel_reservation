<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route ('admin.prestations.index') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white"> Prestations Index</a>
            </div>
    ...
    <div class="m-2 p-2 bg-slate-100 rounded">
        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
          <form method="POST" action="{{route('admin.prestations.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="sm:col-span-6">
              ...
              <div class="sm:col-span-6 pt-5">
                ...
                <div class="mt-1">
                  <textarea id="body" rows="3" name="description" class="shadow-sm focus:ring-indigo-500 appearance-none rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('name') border-red-500 @enderror"></textarea>
                </div>
              </div>
              <div class="sm:col-span-6 pt-5">
                <label for="body" class="block text-sm font-medium text-gray-700 @error('name') border-red-500 @enderror">Categories</label>
                <div class="mt-1">
